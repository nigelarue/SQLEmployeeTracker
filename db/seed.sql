...
INSERT INTO employee (last_name, first_name, role_id, manager_id) VALUES ('Smith', 'Kevin', 1, NULL),('Clark', 'Sarah', 2, 1),('Vas Neemah', 'Tali Zorah', 3, NULL),('Star', 'Patrick', 4, 3),('Gonzalez', 'Alejandro', 5, NULL),('Shepard', 'Jane', 6, 5),('Vakarian', 'Garrus', 7, NULL),('Reigen', 'Arataka', 8, 7);